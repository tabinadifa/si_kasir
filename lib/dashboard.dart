...
class _DashboardScreenState extends State<DashboardScreen> {
  String profileImageUrl = ''; // Variabel untuk menyimpan URL gambar profil
  bool isLoadingProfile = true; // Untuk menangani loading state

  @override
  void initState() {
    super.initState();
    _loadProfileData(); // Panggil fungsi untuk memuat data profil
  }
