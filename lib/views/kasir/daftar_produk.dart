...
import 'package:si_kasir/views/kasir/detail_produk.dart'; // Import halaman detail produk
...
class Product {
  ...
  // Convert Product to Map for TransaksiScreen
...
class _DaftarProdukScreen extends State<DaftarProdukScreen>
  ...
  categoryProducts.forEach((category, products) {
    ...
    if (filteredProducts.isNotEmpty) {
      ...
      categoryWidgets.add(SizedBox(height: 16));
    }
  });
